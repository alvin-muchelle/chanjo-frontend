...
export const MobileMenu: React.FC<MobileMenuProps> = ({
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full bg-[rgba(8,17,32,0.8)] z-40 flex flex-col items-center justify-center transition-all duration-300 ease-in-out md:hidden ${
        menuOpen
