// /app/administered/AdministeredPageContent.tsx
"use client";
...
export default function AdministeredPageContent() {
      ...
      .then((json: ProfileResponse) => {
        ...
        if (json.babies.length > 0) {
          ...
          if (!babyIdFromQuery || !found) {
            ...
            router.replace(`/administered?babyId=${first}`, {
              scroll: false,
            });
          } else {
  ...
  // If there are no babies at all, show a message
